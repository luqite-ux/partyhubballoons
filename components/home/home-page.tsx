...
export function HomePage({ locale }: { locale: string }) {
  return (
    <main>
    <section className="hero hero-light" data-testid="hero">
        <div className="aurora" />
        <div className="container hero-grid">
          <div className="hero-copy">
            <span className="eyebrow">
              <Sparkles size={14} />
              Crafted for standout celebrations
            </span>
            <h1>
              Premium Balloons, Made for <em>Remarkable Celebrations.</em>
            </h1>
            <p>
              Distinctive foil balloons, scalable production, and flexible
              OEM/ODM support for global party brands, distributors, and event
              programs.
            </p>
          ...
          <div className="hero-visual">
            <div className="halo" />
            <Image
              src="/media/partyhub-star-hero.png"
              alt="Colorful agate star foil balloons"
              width={1536}
              height={1236}
              priority
            />
        ...
        <div className="container">
          <div className="section-heading">
            <div>
              ...
              <h2>Balloon designs with retail impact.</h2>
            </div>
          ...
          <div className="product-grid">
            {products.map((p, index) => (
              ...
              >
                ...
                <p>{p.description}</p>
                <b>
                  Discover product <ArrowRight size={15} />
                </b>
              </Link>
            ))}
          </div>
      ...
      <Reveal as="section" className="section gradient">
        <div className="container split">
          <div className="factory">
            <Image
              src="/media/factory/printing-equipment.png"
              alt="Balloon printing equipment"
              width={820}
              height={620}
            />
          </div>
          <div>
            ...
            <h2>From creative brief to production floor.</h2>
            <p>
              Printing, metallizing, film blowing, punching, and bag-making
              capacity support repeatable balloon programs and custom
              collections.
            </p>
            <ul>
              {company.equipment.map((x) => (
                <li key={x}>
                  <BadgeCheck size={18} />
                  {x}
                </li>
          ...
          <div className="process-grid">
            {[
              ...
              <article className="reveal-item" style={{ "--reveal-order": index } as CSSProperties} key={n}>
                ...
                <h3>{t}</h3>
                <p>
                  Confirm requirements and keep each stage clear, practical, and
                  reviewable.
                </p>
              </article>
            ))}
      ...
      <Reveal as="section" className="section light">
        <div className="container custom">
          <div>
            ...
            <h2>Your idea. Our production canvas.</h2>
            <p>
              Build coordinated balloon ranges with custom artwork, color
              themes, language variants, pack formats, and retail-ready
              assortments.
            </p>
            <Link className="button" href={`/${locale}/custom-solutions`}>
      ...
      <Reveal as="section" className="section faq">
        <div className="container">
          <div className="section-heading">
            <div>
              <span className="eyebrow">Buyer essentials</span>
              <h2>Practical answers before you enquire.</h2>
            </div>
          </div>
      ...
      <Reveal as="section" className="quote dark">
        <div className="container">
          ...
          <p>
            Tell us what you need, where it will be sold, and the quantity you
            are planning.
          </p>
